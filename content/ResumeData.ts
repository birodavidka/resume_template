...
export const resumeDATA: Record<PersonId, Record<Lang, ResumeData>> = {
  David: {
    en: {
      ...
      contact: {
        addressLines: ["", "Szombathehy, Hungary"],
    ...
    de: {
      ...
      contact: {
        addressLines: ["", "Szombathely, Ungarn"],
        phone: "+(36 30) 185-5542",
        email: "biro.david93@gmail.com",
        website: "1993.01.23.",
      },
    ...
    hu: {
      ...
      contact: {
        addressLines: ["", "Szombathely, Magyarország"],
        phone: "+(36 30) 185-5542",
        email: "biro.david93@gmail.com",
        website: "1993.01.23.",
      },
  ...
  Dzsenifer: {
    en: {
      ...
      experience: [
        ...
        {
          year: "2020 – 2021",
          company: "Nursing Home, Zalaegerszeg",
          position: "Nursing Assistant",
          summary: "Provided daily care and support for elderly residents.",
          bullets: [
            "Carried out daily nursing and caregiving tasks",
            "Assisted residents with daily activities",
            "Maintained a safe and supportive environment with empathy",
          ],
        },
      ],
    },
    de: {
        ...
        experience: [
          ...
          {
            year: "2020 – 2021",
            company: "Seniorenheim Zalaegerszeg",
            position: "Pflegeassistentin",
            summary: "Unterstützung der älteren Bewohner im Alltag und bei der täglichen Pflege.",
            bullets: [
              "Durchführung von täglichen Pflege- und Betreuungsaufgaben",
              "Unterstützung der Bewohner bei alltäglichen Aktivitäten",
              "Empathische Begleitung und Sicherstellung einer sicheren Umgebung",
            ],
          },
        ],
    } as ResumeData,
    hu: {nameTop: "KULCSAR",
      ...
      experience: [
        ...
        {
          year: "2020 – 2021",
          company: "Zalaegerszegi Idősek Otthona",
          position: "Ápolói asszisztens",
          summary: "Idősgondozási feladatok ellátása, lakók mindennapi támogatása.",
          bullets: [
            "Napi ápolási és gondozási feladatok ellátása",
            "Segítségnyújtás a lakók mindennapi tevékenységeiben",
            "Empatikus támogatás és biztonságos környezet fenntartása",
          ],
        },
      ],} as ResumeData,
  },
